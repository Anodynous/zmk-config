/* Copied from QMK, modified for ZMK keycodes 2021
 * 
 * Copyright 2020
 *
 ...
 */
// Row 1
#define FI_AT   RALT(FI_2)    // @
#define FI_PND  RALT(FI_3)    // £
#define FI_DLR  RALT(FI_4)    // $
#define FI_EURO RALT(FI_5)    // €
#define FI_LCBR RALT(FI_7)    // {
#define FI_LBRC RALT(FI_8)    // [
#define FI_RBRC RALT(FI_9)    // ]
#define FI_RCBR RALT(FI_0)    // }
#define FI_BSLS RALT(FI_PLUS) // (backslash)
// Row 2
#define FI_TILD RALT(FI_DIAE) // ~ (dead)
// Row 4
#define FI_PIPE RALT(FI_LABK) // |
#define FI_MICR RALT(FI_M)    // µ